...
We have reached the finish line. In [L09 - Inference](L09_Inference_and_Sampling.md), we saw that our model can complete text. However, if you ask a "Base" model: *"What is the capital of France?"*, it might respond with: *"...and what is the capital of Germany?"*
...
**What's next for you?** You could take the code from [L07](https://www.google.com/search?q=L07_Assembling_the_GPT.md) and train it on a small dataset like **TinyShakespeare** or **OpenWebText**. Or, you could explore **Quantization** to make these models run faster on your laptop.
